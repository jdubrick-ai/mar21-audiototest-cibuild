...
3) Access the `workbench` named `mar21-audiototest-cibuild-notebook`.
...
5) In the terminal, run `cd mar21-audiototest-cibuild` to navigate to your sample app's directory.
